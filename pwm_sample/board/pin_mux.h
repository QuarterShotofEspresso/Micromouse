...
#define BOARD_INITPINS_SCLK_PERIPHERAL                                      PWM1   /*!< Device name: PWM1 */
#define BOARD_INITPINS_SCLK_SIGNAL                                             A   /*!< PWM1 signal: A */
#define BOARD_INITPINS_SCLK_CHANNEL                                           3U   /*!< PWM1 A channel: 3 */

/* GPIO_AD_B0_09 (coord F14), JTAG_TDI/J21[5]/ENET_RST/J22[5] */
#define BOARD_INITPINS_MCLK_PERIPHERAL                                      PWM2   /*!< Device name: PWM2 */
#define BOARD_INITPINS_MCLK_SIGNAL                                             A   /*!< PWM2 signal: A */
#define BOARD_INITPINS_MCLK_CHANNEL                                           3U   /*!< PWM2 A channel: 3 */
