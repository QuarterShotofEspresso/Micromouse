...
- {pin_num: F14, pin_signal: GPIO_AD_B0_09, label: 'JTAG_TDI/J21[5]/ENET_RST/J22[5]', identifier: MCLK}
- {pin_num: G13, pin_signal: GPIO_AD_B0_10, label: 'JTAG_TDO/J21[13]/INT1_COMBO/ENET_INT/J22[6]/U32[11]', identifier: INT1_COMBO;SCLK}
...
- pin_list:
  - {pin_num: G13, peripheral: PWM1, signal: 'A, 3', pin_signal: GPIO_AD_B0_10, identifier: SCLK, direction: OUTPUT, pull_up_down_config: Pull_Down_100K_Ohm, slew_rate: Slow}
  - {pin_num: F14, peripheral: PWM2, signal: 'A, 3', pin_signal: GPIO_AD_B0_09, direction: OUTPUT, pull_up_down_config: Pull_Down_100K_Ohm, pull_keeper_select: Keeper,
    drive_strength: R0_6}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B0_09_FLEXPWM2_PWMA03,   /* GPIO_AD_B0_09 PAD functional properties : */
